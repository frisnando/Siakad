    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                            ...
                            ?>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        if ($data['useracc_status'] == "1") {
                                        ?>
                                            <a onclick="return confirm('Yakin Akan Menonaktifkan Akun Ini...???')" href="?page=mahasiswa&aksi=aktivasi&status=<?php echo $data['useracc_status']; ?>&id=<?php echo $data['nim']; ?>" class=" btn btn-warning"><i class="fa fa-ban"></i> Nonaktifkan</a>
                                        <?php
                                        } else {
                                        ?>
                                            <a onclick="return confirm('Yakin Akan Mengaktifkan Akun Ini...???')" href="?page=mahasiswa&aksi=aktivasi&status=<?php echo $data['useracc_status']; ?>&id=<?php echo $data['nim']; ?>" class=" btn btn-primary"><i class="fa fa-check"></i> Aktifkan</a>
                                        <?php
                                        }
                                        ?>
                ...
                <a onclick="return confirm('Yakin Akan Menonaktifkan Semua Akun...???')" href="?page=mahasiswa&aksi=nonaktif_all" class=" btn btn-danger" style="margin-top: 8px;"><i class="fa fa-ban"></i> Nonaktifkan Semua</a>

        ...
        <div id="wrapper">
            <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">SIAKAD PGRI</a>
                ...
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        <li class="text-center">
                            ...
                            <!-- <h3 style="color: white;">SIAKAD Universitas</h3> -->
                        </li>
                        ...
                        <?php if ($_SESSION['admin']) { ?>
                            ...
                            <li>
                                <a href="?page=ruang"><i class="glyphicon glyphicon-th-list"></i>Ruangan </a>
                            </li>
                            ...
                            <li>
                                <a href="?page=bukti"><i class="glyphicon glyphicon-th"></i>Bukti Pembayaran </a>
                            </li>
                        <?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            if ($page == "mahasiswa") {
                                ...
                                if ($aksi == "aktivasi") {
                                    include "page/mahasiswa/aktivasi.php";
                                }
                                if ($aksi == "nonaktif_all") {
                                    include "page/mahasiswa/nonaktif_all.php";
                                }
                            }

                            if ($page == "bukti") {
                                if ($aksi == "") {
                                    include "page/bukti/mahasiswa.php";
                                }
                                if ($aksi == "detail") {
                                    include "page/bukti/detail.php";
                                }
                                if ($aksi == "aktivasi") {
                                    include "page/bukti/aktivasi.php";
                                }
                                if ($aksi == "nonaktif_all") {
                                    include "page/bukti/nonaktif_all.php";
                                }
                            }

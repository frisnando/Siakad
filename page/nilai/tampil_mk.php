                        ...
                        <?php
                         ...
                         ?>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                	<a href="?page=nilai&aksi=lihat_mhs&kode_mk=<?php echo $data['kode_mk']; ?>&dosen=<?php echo $data['kode_dosen']; ?> " class=" btn btn-info" ><i class="fa fa-edit"></i> Nilai Mahasiswa</a>

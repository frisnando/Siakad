                                     ...
                                     ?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                            	...
                                            	<a href="?page=nilai&aksi=input&id=<?php echo $data['nim']; ?>&smester=<?php echo $data['smester'];?>&krs=<?php echo $data['kode'] ?>&kode_mk=<?php echo $kode_mk;  ?>&dosen=<?php echo $dosen; ?>" class=" btn btn-success" ><i class="fa fa-edit"></i> Masukan Nilai</a>
                           ...
                           ?>
                              <tr>
                                  ...
                                  <td align="center">
                                      ...
                                      <a href="?page=nilai&aksi=edit&id=<?php echo $data ['id'];?>&nim=<?php echo $data['nim']; ?>&smester=<?php echo $data['smester'];?>&krs=<?php echo $data['kode'] ?>&kode_mk=<?php echo $kode_mk;  ?>&dosen=<?php echo $dosen; ?>" class="btn btn-info">Edit</a>

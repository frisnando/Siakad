				...
				<div class="row">
					<div class="col-md-12">
						...
						<form role="form" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label>NIP :</label>
								<input class="form-control" type="nip" name="nip" placeholder="Input NIP" />
							</div>
					...
					if (isset($_POST['simpan'])) {
						...
						if ($upload) {
							...
							$koneksi->query("insert into tb_dosen (kode_dosen, nama_dosen, nip, telpon, email,  alamat, foto)values('$kode', '$nama', '$nip', '$telpon', '$email',  '$alamat',  '$foto')");

							$koneksi->query("insert into tb_user set user_id='$kode', nama='$nama', pass='$pass', level='dosen', useracc_status=1, foto='$foto'");

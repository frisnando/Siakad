			        ...
			        <div class="col-md-6">
			            ...
			            <form role="form" method="POST" enctype="multipart/form-data">
			                ...
			                <div class="form-group">
			                 ...
			                 <div class="form-group">
			                    <label>Nama :</label>
			                    <input class="form-control" name="nama" value="<?php echo $tampil['nama_dosen']; ?>" />
			                </div>

							<div class="form-group">
								<label>NIP :</label>
								<input class="form-control" type="nip" name="nip" placeholder="Input NIP" value="<?php echo $tampil['nip']; ?>" />
							</div>
...
<?php 
	...
	if(!empty($lokasi)) {
		...
		$koneksi->query("UPDATE  tb_dosen SET  nama_dosen='$nama', nip='$nip',  alamat='$alamat',  email='$email', telpon='$telpon', foto='$foto' where kode_dosen='$kode'");
		...
		$koneksi->query("UPDATE  tb_dosen SET  nama_dosen='$nama', nip='$nip',  alamat='$alamat', email='$email', telpon='$telpon'  where kode_dosen='$kode'");

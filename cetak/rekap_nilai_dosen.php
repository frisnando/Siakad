...
<tr>
	...
	<td style="font-size: 12px;">SEKOLAH TINGGI MANAJEMEN INFORMATIKA DAN KOMPUTER</td>
</tr>
<tr>

</tr>
<tr style="text-align: center;">
	<td style="font-size: 12px; text-align: center;">MUHAMMADIYAH JAKARTA</td>
</tr>

<tr>
	<td style="font-size: 12px; text-align: center;">Jalan Kelapa Dua Wetan No.17 Ciracas - Jakarta Timur</td>
</tr>
<tr>
	<td style="font-size: 12px; text-align: center;">Telp: 021-87717489 / 021-87717490</td>
</tr>
<tr>
	<td style="font-size: 12px; text-align: center;">Email : stmikmuhjkt@gmail.com / Website : hhtp//www.stmikmj.ac.id</td>
</tr>
<br>
<hr>
...
<br>
      ...
      <a style="text-decoration: none; color: black; margin-left: 510px; font-size: 12px;">Jakarta, '.$tgl4.'</a><br>
      <a style="text-decoration: none; color: black; margin-left: 510px; font-size: 12px;">Disetujui,</a><br>
      <a style="text-decoration: none; color: black; margin-left: 510px; font-size: 12px;">Ka.BAAK</a><br><br><br><br><br><br>
      <a style="text-decoration: none; color: black; margin-left: 510px; font-size: 12px;">Rudiantara M.Kom</a>

                    ...
                    <div class="col-md-12">
                        <form role="form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kode_mk" value="<?php echo $data['kode_mk']; ?>" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <option value="9" <?php if( $data['smester']=='9'){echo "selected"; } ?>>9</option>
                                <option value="10" <?php if( $data['smester']=='10'){echo "selected"; } ?>>10</option>
                                <option value="11" <?php if( $data['smester']=='11'){echo "selected"; } ?>>11</option>
                                <option value="12" <?php if( $data['smester']=='12'){echo "selected"; } ?>>12</option>
                                </select>
                            </div>
...
<?php 
	...
	if (isset($_POST['ubah'])) {
		...
		$ubah = $koneksi->query("update tb_matkul set  kode_mk='$kode_mk', nama_mk='$nama', sks='$sks', smester='$smester' where kode_mk='$kode' ");
